...
public class ReviewFactory {
    ...
    public void createReviews(){
        ...
        reviewArrayList.add(new Review("Noah","You guys are the best I just got my free case",5.0,R.drawable.noah));
        ...
        reviewArrayList.add(new Review("Beth","The free prizes are so much fun ive never seen anything like it",4.0,R.drawable.beth));
        ...
        reviewArrayList.add(new Review("Daisy"," How long for the free prize shipping I just one",3.8,R.drawable.daisy));
